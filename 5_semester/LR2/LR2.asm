...
%define TSS_3_SELECTOR (7 << 3)

%define TSS_1_BASE (0x2000)
%define TSS_2_BASE (0x2200)
%define TSS_3_BASE (0x2400)
 
%define DELAY 1030000000000
...
make_tss:
    ...
    mov     dword [edi + 0x48], DATA_SELECTOR 
    mov     dword [edi + 0x4c], CODE_SELECTOR 
    mov     dword [edi + 0x50], DATA_SELECTOR 
    mov     dword [edi + 0x54], DATA_SELECTOR 
...
GDT:
    dq 0                            
    db 0xff, 0xff, 0, 0, 0, 0x92, 0x8f, 0
    db 0xff, 0xff, 0, 0, 0, 0x9a, 0xcf, 0
    db 0xff, 0xff, 0, 0, 0, 0x92, 0x0f, 0
    db 0xff, 0xff, 0, 0, 0, 0x9a, 0x0f, 0 
